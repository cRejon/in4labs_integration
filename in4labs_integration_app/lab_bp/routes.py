...
from in4labs_integration_app import url_prefix, boards, user, user_end_time
from in4labs_integration_app.lab_bp import bp
from in4labs_integration_app.config import Config
from in4labs_integration_app.utils import upload_sketch
...
def index():
    ...
    return render_template('index.html', boards=boards, navtabs=navtabs,
                                ...
                                node_red_url=url_prefix+'/nodered/')
...
@bp.route('/get_flows', methods=['GET'])
@login_required
def get_flows(): 
